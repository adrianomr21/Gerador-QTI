...
<organizations/>
    ...
    //<!-- IMAGEM ------------------------------------------------------------------------------------------------- -->
            ...
            for (var i = 0; i < questions.length; i++) {
                ...
                for(var j=1; j < question.length; j++){
                    ...
                    if(j==1){
                        ...
                        if(j>2)div.innerHTML +="<br/>";//SÓ DÁ UMA QUEBRA DE LINHA NA VISUALIZAÇÃO DAS QUESTÕES APARTIR DAS ALTERNATIVAS
        ...
        document.addEventListener("DOMContentLoaded", function () {
          ...
          const convertButton = document.getElementById("convertToHtml");
